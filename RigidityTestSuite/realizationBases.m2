...
-- This is a script to take each Laman graph G on n vertices
-- and for each permutation of the edge labels, compute the number
-- of realization bases
-- 
n = 6
...
for i from 0 to maxInd -1 do (
	...
	if #basesList == r then ( -- only print out if the #realisation bases is equal to the realisation number
	    print(p, #basesList, toList \ M.cache.groundSet, toList \ basesList);
